...
import co.com.persona.model.exception.ApplicationException;
import co.com.persona.model.exception.ValidationException;
  ...
  public Mono<ServerResponse> filter(ServerRequest request, HandlerFunction<ServerResponse> next) {
    return next
        ...
        .onErrorResume(ApplicationException.class, ex -> {
              ...
              log.debug("ApplicationException caught: {} - {}", ex.getFullErrorCode(), ex.getMessage());
